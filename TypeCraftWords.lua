...
TypeCraftWords = {
    ...
    "paper", "often", "always", "music", "those", "both", "mark", "book", "letter", "until",
    ...
    "song", "measure", "state", "product", "black", "short", "numeral", "class", "wind", "question",
    ...
    "hold", "west", "ground", "interest", "reach", "fast", "five", "sing", "listen", "six",
    ...
    "road", "map", "science", "rule", "govern", "pull", "cold", "notice", "voice", "fall",
    "power", "town", "fine", "certain", "fly", "unit", "lead", "cry", "dark", "machine",
    "note", "wait", "plan", "figure", "star", "box", "noun", "field", "rest", "correct",
    "able", "pound", "done", "beauty", "drive", "stood", "contain", "front", "teach", "week",
    "final", "gave", "green", "oh", "quick", "develop", "sleep", "warm", "free", "minute",
    ...
    "surface", "deep", "moon", "island", "foot", "yet", "busy", "test", "record", "boat",
    "common", "gold", "possible", "plane", "age", "dry", "wonder", "laugh", "thousand", "ago",
    "ran", "check", "game", "shape", "yes", "hot", "miss", "brought", "heat", "snow",
    "bed", "bring", "sit", "perhaps", "fill", "east", "weight", "language", "among"
}